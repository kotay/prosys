...
p client.in_stock?(item)
# => true
p client.weight?(item)
# => "1.585"
p client.price?(item)
# => "179.00"
...
p client.order_status(order_id)
# => "cancelled"
p client.order_released(order_id)
# => "yes"

cust_ref_id = "286"
p client.order_by_ref(cust_ref_id)
